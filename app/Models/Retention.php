...
class Retention extends Model
{
    ...
    protected $fillable = [
        ...
        'proveedor_tipo_doc', 'proveedor_num_doc', 'proveedor_razon_social', 'proveedor_direccion',
        'regimen', 'tasa', 'imp_retenido', 'imp_pagado', 'observacion',
    ...
    {
        return $this->hasMany(RetentionItem::class);
    }
